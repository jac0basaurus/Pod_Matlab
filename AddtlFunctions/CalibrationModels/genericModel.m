function func = genericModel(a)
%This main funciton returns a handle for the relative
...
function [fittedMdl, y_hat] = genericGenerate(Y,X,settingsSet)
...
function genericReport(fittedMdl,settingsSet)
fittedMdl
end